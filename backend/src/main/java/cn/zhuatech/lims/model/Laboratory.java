...
@Entity @Table(name="lims_laboratory") public class Laboratory extends BaseEntity {
    ...
    protected Laboratory(){} public Laboratory(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
