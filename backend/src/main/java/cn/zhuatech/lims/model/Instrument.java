...
@Entity @Table(name="lims_instrument") public class Instrument extends BaseEntity {
    ...
    protected Instrument(){} /**
                              * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                              */
public Instrument(String code,String name,Laboratory laboratory,Status status,int oee){this.code=code;this.name=name;this.laboratory=laboratory;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
